...
const destinations = [
  "South Africa", "Egypt", "Qatar", "Tanzania", "Thailand",
  "Dubai", "Nigeria", "Zimbabwe", "Turkey", "Dubai, UAE",
  "Uganda", "Ethiopia", "Oman",
]
...
export const serviceFields: Record<ServiceId, FieldDef[]> = {
  "Travel Consultancy": [
    ...clientFields,
    { id: "destination", label: "Destination",            type: "select",   options: destinations,                                                                            required: true,  icon: <MapPin    className="h-4 w-4" /> },
  ...
  "Visa Assistance": [
    ...clientFields,
    { id: "destination", label: "Destination Country", type: "select",  options: destinations,                                                                                required: true,  icon: <MapPin   className="h-4 w-4" /> },
  ...
  "Tour Bookings": [
    ...clientFields,
    { id: "destination", label: "Tour Destination",      type: "select",   options: destinations,                                                                             required: true,  icon: <MapPin   className="h-4 w-4" /> },
  ...
  "Airport Transfers": [
    ...
    { id: "destination",   label: "Country",             type: "select",  options: destinations,                                                                              required: true,  icon: <MapPin   className="h-4 w-4" /> },
...
function FieldInput({
  ...
  const wrapper = (input: React.ReactNode) => (
    <div className="relative">
      ...
      <div className={field.icon ? "pl-9" : ""}>{input}</div>
    </div>
  )
    ...
    return wrapper(
      <div className="relative">
        <select
          ...
          className={`${base} appearance-none pr-10 ${field.icon ? "pl-0" : ""}`}
          style={style}
        >
  ...
  return wrapper(
    <input
      ...
      onChange={(e) => onChange(e.target.value)}
      placeholder={field.placeholder}
      className={`${base} ${field.icon ? "pl-0" : ""}`}
      style={style}
    />
  )
}
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className="mt-1 text-sm text-white/80">Fill in the form below and our team will get back to you within 24 hours.</p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {status === "success" ? (
            ...
            <div className="flex flex-col items-center justify-center gap-5 px-8 py-16 text-center">
              ...
              <div>
                <h3 className="text-2xl font-extrabold text-gray-900">Request Sent!</h3>
                <p className="mt-3 max-w-sm text-gray-500 leading-relaxed">
          ...
          <div className="shrink-0 border-t bg-gray-50 px-7 py-5">
            ...
            <div className="flex items-center justify-between gap-4">
              <p className="text-xs text-gray-400">
                No payment required · We respond within 24 hrs
              </p>
              <button
